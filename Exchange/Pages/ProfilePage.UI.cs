...
namespace Exchange.Pages
{
    public partial class ProfilePage
    {
        ...
        public void InitializeComponents()
        {
            ...
            infoLayout.Children.Add(UIHelper.UIHelper.FormGroup("ic_user.png", _firstnameLabel));
            ...
            infoLayout.Children.Add(UIHelper.UIHelper.FormGroup(string.Empty, _lastnameLabel));
