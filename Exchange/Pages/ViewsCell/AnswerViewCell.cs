...
{
	public class AnswerViewCell : ViewCell
	{
		...
		protected override void OnBindingContextChanged()
		{
			...
			Answer comment = this.BindingContext as Answer;
			...
			if (comment.User != null)
			{
				...
				if (!string.IsNullOrEmpty(comment.User.Name))
					_headerLabel.Text = comment.User.Name;
			}
